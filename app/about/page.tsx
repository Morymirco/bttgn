      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
            ...
            >
              <div className="w-80 h-56 mx-auto mb-8 rounded-2xl overflow-hidden">
                <img 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Nous utilisons les équipements les plus modernes pour garantir la précision et la qualité.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-poppins)' }}>
                Positionnement satellite haute précision
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-gray-600" style={{ fontFamily: 'var(--font-poppins)' }}>
                Mesures topographiques précises
              </p>
            </motion.div>
